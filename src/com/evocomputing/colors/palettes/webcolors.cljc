...
(def html4-name-to-rgb (into {} (map (fn [rec] [(rec 1) (rec 0)]) html4-colors)))
(def html4-rgb-to-name (into {} (map (fn [[k v]] [v k]) html4-name-to-rgb)))
...
(def x11-name-to-rgb (into {} (map (fn [rec] [(rec 1) (rec 0)]) x11-colors)))
(def x11-rgb-to-name (into {} (map (fn [[k v]] [v k]) x11-name-to-rgb)))
